/**
 * CodeBuddy International OAuth provider configuration.
 * Flow: Device Code (browser OAuth polling)
 * Mirrors codebuddy-cn against the .ai domain.
 */

import type { BaseProviderConfig, OAuthProviderHandler } from '../types';

const CODEBUDDY_INTL_CONFIG: BaseProviderConfig = {
...
const codebuddyIntl: OAuthProviderHandler = {
