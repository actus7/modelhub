...
export const models = [
  { capabilities: { documents: true, images: false, tools: true, fast: true }, id: 'llama-3.3-70b-versatile', maxOutputTokens: 8192, name: 'Llama 3.3 70B (Groq)' },
  { capabilities: { documents: true, images: false, tools: true, fast: true }, id: 'openai/gpt-oss-20b', maxOutputTokens: 8192, name: 'GPT OSS 20B (Groq)' },
]
